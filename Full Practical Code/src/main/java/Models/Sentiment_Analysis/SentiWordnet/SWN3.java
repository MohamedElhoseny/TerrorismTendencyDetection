package Models.Sentiment_Analysis.SentiWordnet;
...
public class SWN3
{
  ...
  {
  	  double score = dictionary.getOrDefault(word + "#" + pos, 0.0);
  	  //give word and pos and return its score
	  //System.out.println("SWN : "+word+" = "+score);
	  return score;
  }
}