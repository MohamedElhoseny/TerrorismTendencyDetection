...
public class GraphView extends JPanel {
    ...
    public GraphView(Graph g, String label)
    {
        ...
        focusGroup.addTupleSetListener((ts, add, rem) -> {
...
//        opanel.add(overview);
        ...
        m_vis.run("draw"); //used to run the display
        add(split);
    }
