/**
 * Copyright (documentation) 2004-2006 Regents of the University of California.
 * See "license-prefuse.txt" for licensing terms.
 */
package Models.Evaluation.visualization.demos;
...
class AggregateDragControl extends ControlAdapter {
    ...
    /**
     * @see prefuse.controls.Control#itemEntered(prefuse.visual.VisualItem, MouseEvent)
     */
    ...
    /**
     * @see prefuse.controls.Control#itemExited(prefuse.visual.VisualItem, MouseEvent)
     */
    ...
    /**
     * @see prefuse.controls.Control#itemPressed(prefuse.visual.VisualItem, MouseEvent)
     */
    ...
    /**
     * @see prefuse.controls.Control#itemReleased(prefuse.visual.VisualItem, MouseEvent)
     */
    ...
    /**
     * @see prefuse.controls.Control#itemDragged(prefuse.visual.VisualItem, MouseEvent)
     */
