...
public class ZipDecode extends Display implements Constants {
    ...
    public static final String ZIPCODES = "Models/Evaluation/visualization/demos/data/zipcode.txt";
    public static final String STATES = "Models/Evaluation/visualization/demos/data/state.txt";
    ...
    public static JFrame demo(String table) throws DataIOException {
        ...
        JFrame frame = new JFrame("p r e f u s e  |  z i p d e documentation o d e");
