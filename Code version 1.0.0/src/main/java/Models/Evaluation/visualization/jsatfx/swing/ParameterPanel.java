package Models.Evaluation.visualization.jsatfx.swing;
...
public class ParameterPanel extends JPanel
{
    ...
    private static final long serialVersionUID = -7333731204670319777L;
    ...
    private void initComponents()
    {
        ...
        jPanelParametersLayout.setHorizontalGroup(jPanelParametersLayout.createParallelGroup(Alignment.LEADING)
            .addGap(0, 0, Short.MAX_VALUE)
        );
        jPanelParametersLayout.setVerticalGroup(jPanelParametersLayout.createParallelGroup(Alignment.LEADING)
